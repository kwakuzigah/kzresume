...
public class RatingReminder {
     ...
     */
    public RatingReminder(Activity mActivity, RatingInterface ratingInterface) {
        super();
    ...
    private void showAskingDialogFragment() {
        ...
        this.ratingInterface.dialogShowed();
        ...
        dialogFragment.setOnRating(new OnRating() {
            ...
            public void OnRatingCancel() {
                ratingInterface.dialogCanceled();

            }
        });

        dialogFragment.show(mActivity.getFragmentManager(), "rating");
    }
